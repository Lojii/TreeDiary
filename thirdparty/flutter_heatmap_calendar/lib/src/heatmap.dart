...
class HeatMap extends StatefulWidget {
  ...
  ///
  /// Default value is false.
  final bool? showWeeksText;

  /// Show day text in every blocks if the value is true.
  ///
  /// Default value is false.
  final bool? showMonthsText;
  ...
  const HeatMap({
    ...
    this.defaultColor,
    this.showText = false,
    this.showWeeksText = true,
    this.showMonthsText = true,
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        _scrollableHeatMap(HeatMapPage(
          ...
          showWeeksText:widget.showWeeksText,
          showMonthsText:widget.showMonthsText,
        )),
